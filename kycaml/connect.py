"""Native cognis-connect emit for kycaml — forward findings to any platform.

Maps kycaml's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    kycaml ... --format json | kycaml-emit --to stix
    kycaml-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
